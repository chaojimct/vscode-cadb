...
(function() {
  ...
  // 检查 API 是否可用
  if (typeof acquireNotebookRendererApi === 'undefined') {
    console.error('acquireNotebookRendererApi is not available');
    return;
  }
  ...
  try {
    ...
    console.error('Error initializing notebook renderer:', error);
  }
})();
